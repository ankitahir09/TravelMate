    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-[#fdf6e3] via-[#f9e4d4] to-[#e4c1f9] text-gray-800 font-sans">
      ...
      <section className="w-full px-6 md:px-20 py-20 flex flex-col items-center text-center">
        <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
          ...
          <span className="text-[#6a0dad]">TravelMate</span>
        </h1>
        <p className="text-lg md:text-xl max-w-2xl mb-10">
          Tell us where you want to go, how many days, and your interests. Our
          AI powered by Gemini will help you plan the perfect itinerary — plus
      ...
      <section className="px-6 md:px-20 py-16 bg-white/70 backdrop-blur-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <div className="p-6 bg-white rounded-xl shadow-lg">
            ...
            <p>
              Just tell us your destination and duration — our Gemini AI crafts
              your trip plan with daily tips and ideas.
            </p>
          </div>
          <div className="p-6 bg-white rounded-xl shadow-lg">
            ...
            <p>
              View and connect with local drivers, restaurants, and artisans
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg">
            ...
            <p>
              Vendors can quickly submit their details and appear in our smart
      ...
      <section className="px-6 md:px-20 py-20 text-center bg-[#fdf6e3]">
        ...
        <p className="mb-8 max-w-xl mx-auto">
          Whether you're a traveler or a vendor, TravelMate is here to connect
      ...
      <footer className="text-center py-6 bg-white/50 text-sm">
        &copy; {new Date().getFullYear()} TravelMate. Built with ❤️ and Gemini
        API.
      </footer>
    </div>
  );
